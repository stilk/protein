...
def GetExpLevelsForASEvents(ASType, PSI_Threshold):
    ...
    Exp[Exp['Hugo_Symbol'] != 0].to_csv(OutDir + 'TCGA_AS_EventsRemoved'+ ASType +'_Counts_ThresholdByPSI_' + str(PSI_Threshold))
    Exp = Exp[Exp['Hugo_Symbol'] == 0] # remove AS events that overlap with mutations
